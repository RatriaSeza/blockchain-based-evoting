...
const Button: React.FC<ButtonProps> = ({ label, customClass }) => {
  return (
    <button className='group p-[2px] hover:bg-gradient-to-r hover:from-[rgb(85_217_198)] hover:to-[rgb(181_217_130)] rounded transition ease-in-out duration-500 cursor-pointer'>
